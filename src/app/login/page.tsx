...
import { AlertCircle, Mail, User, Eye, EyeOff, Lock } from "lucide-react";
...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center px-4 py-12">
      ...
      <button onClick={handleGoogleLogin} className="bg-red-500 text-white p-2 rounded w-full mb-2">Sign in with Google</button>
